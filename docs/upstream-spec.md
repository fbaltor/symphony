<!-- UPSTREAM SOURCE
  ...
  File       : SPEC.md
  Fetched at : eaa457d96acd (2026-04-27) — "Clarify Symphony service specification (#61)"

  To update:
    1. gh api "repos/openai/symphony/commits?path=SPEC.md&per_page=1" \
          --jq '.[0] | {sha: .sha[:12], date: .commit.committer.date, message: (.commit.message | split("\n")[0])}'
    2. gh api "repos/openai/symphony/contents/SPEC.md" --jq '.content' | base64 -d > /tmp/symphony-spec.md
    3. Replace this file's body with /tmp/symphony-spec.md; update the sha/date/message above.
-->
